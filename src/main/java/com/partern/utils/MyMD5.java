...
public class MyMD5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("带盐密文：" + MD5WithSalt(input));
    }
    ...
    */
     ...
     *@Descrption:  MD5加盐，盐的获取分两种情况;输入明文加盐；输出密文带盐(将salt存储到hash值中)
     */
    public static boolean validMD5WithSalt(String inputStr,String queriedHash) {
        try {
            MessageDigest md = MessageDigest.getInstance("MD5");//申明使用MD5算法,更改参数为"SHA"就是SHA算法了
            ...
            hashResult = new String(cs);
            return hashResult.equals(queriedHash);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
